...
import { Star, ShoppingCart, Heart, ChevronRight, Clock } from "lucide-react";
...
const LatestProducts = () => {
    ...
    // Fetch latest products from Firestore (ordered by createdAt)
    useEffect(() => {
                ...
                {products.map((product) => (
                    ...
                    >
                        ...
                        <div className="aspect-square flex items-center justify-center text-6xl bg-gray-100 relative overflow-hidden">
                            {/* New Badge */}
                            <span className="absolute top-2 left-2 bg-blue-500 text-white text-xs px-2 py-1 rounded flex items-center gap-1 z-10">
                                <Clock size={12} />
                                New
                            </span>
